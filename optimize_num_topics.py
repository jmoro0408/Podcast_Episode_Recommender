...
def evaluate_graph(dictionary: gensim.corpora.Dictionary,
    ...
    for num_topics in range(START, limit, STEP):
        ...
        lm = LdaModel(corpus=corpus,
                      ...
                      chunksize = 2044)
        lm_list.append(lm)
        cm = CoherenceModel(model=lm, texts=texts, dictionary=dictionary, coherence='u_mass')
...
if __name__ == "__main__":
    lda = load_lda_model(r"/Users/jamesmoro/Documents/Python/Podcast_Episode_Recommender/Results/model")
    doc_term_matrix = load_lda_model(r"/Users/jamesmoro/Documents/Python/Podcast_Episode_Recommender/Results/model.id2word")
    ...
    lm_list, c_v = evaluate_graph(dictionary=index_dict,
                                  corpus=corpus,
                                  texts=docs,
                                  limit = 200)
